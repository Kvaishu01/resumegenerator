...
#setup LLm using hugging face pipeline
...
def breakdown_task_tool(input):
    return f"""" here's how to break down this task 
        ...
             5.polish"""
#create tool 
tool=[Tool(name="LearnPlanner",func=breakdown_task_tool,description="""use this tool to break large goal to smaller goal""")]
#create agent
agent=initialize_agent(tools=tool,llm=llm,agent=AgentType.ZERO_SHOT_REACT_DESCRIPTION,verbose=True)
#run agent 
goal="Write a blog about the future of AI in education?"
